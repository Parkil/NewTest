...
class DjangoPasswordHasher {
    public final Integer DEFAULT_ITERATIONS = 30000;
    ...
    private static void runTests() {
        ...
        System.out.println();
        passwordShouldMatch("alslekd13@", "pbkdf2_sha256$30000$OKD8ucXPB2ta$1pWr9vxvBT3zwPLHKV8IMpJaJV2RrtIV/VIrk/Bb/gM=");
        /*
    ...
    private static void passwordShouldMatch(String password, String expectedHash) {
        ...
        if (hasher.checkPassword(password, expectedHash)) {
            System.out.println(password+"====="+expectedHash);
